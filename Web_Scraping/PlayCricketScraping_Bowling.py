...
def login_and_scrape():
    ...
    with sync_playwright() as p:
        ...
        page.click('a[href="/Statistics?season=258&sub_tab=Standard&tab=Bowling"]')
        page.wait_for_selector("table#stats-table-rows")
        ...
        #final_df = df.sort_values(by='WICKETS', ascending=False)
        # final_df.to_csv("all_bowling_stats.csv", index=False)
        # print(final_df.head())
